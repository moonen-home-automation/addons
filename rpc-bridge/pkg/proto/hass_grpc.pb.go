...
type EventsClient interface {
	Subscribe(ctx context.Context, in *EventSubscribeRequest, opts ...grpc.CallOption) (Events_SubscribeClient, error)
}
...
func (c *eventsClient) Subscribe(ctx context.Context, in *EventSubscribeRequest, opts ...grpc.CallOption) (Events_SubscribeClient, error) {
...
type EventsServer interface {
	Subscribe(*EventSubscribeRequest, Events_SubscribeServer) error
...
func (UnimplementedEventsServer) Subscribe(*EventSubscribeRequest, Events_SubscribeServer) error {
